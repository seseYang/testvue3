<template>
    <div class="content-me">
        <van-row>
            ...
            <van-col v-if="!login" span="24">
                <van-col span="24">
                    <van-col span="4" offset="6">
                        <van-icon class="iconfont" class-prefix="icon" name="weixin-copy" size="5rem" color="#eee9ed"/>
                    </van-col>
                    <van-col span="4" offset="2">
                        <van-icon class="iconfont" class-prefix="icon" name="qq" size="4.44rem" color="#eee9ed"/>
                    </van-col>
                </van-col>
                <h3 style="text-align: center">一键登录，赢取神秘大奖</h3>
            </van-col>
            <van-col v-if="login" span="24">
                ...
                <van-col class="me-name-fu" span="10" offset="2">
                    <h3>Name</h3>
                    <a>查看个人主页</a>
                </van-col>
            </van-col>
